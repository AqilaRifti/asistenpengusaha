...
const { fetchUserDetails, logout, userEmail, userDisplayName } = useAuth();
fetchUserDetails();
const sidebarSVGIconWidth = "18";
const sidebarSVGIconHeight = "18";
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger as-child>
                <SidebarMenuButton
                  size="lg"
                  class="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground border flex"
                >
                  <div
                    class="flex aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground"
                  >
                    <i v-html="activeTeam.logo"></i>
                  </div>
              ...
              >
                ...
                >
                  <div
                    class="flex size-6 items-center justify-center rounded-sm border p-3"
                  >
                    <i v-html="team.logo"></i>
                  </div>
                  {{ team.name }}
              ...
              <SidebarMenuItem>
                <CollapsibleTrigger as-child>
                  <SidebarMenuButton :tooltip="item.title">
                    ...
                    <LucideChevronRight
                      class="ml-auto transition-transform duration-200 group-data-[state=closed]/collapsible:rotate-90"
                    />
                  </SidebarMenuButton>
                </CollapsibleTrigger>
                <CollapsibleContent>
